...
/*指定位置が置ける位置か調べるためのクラス*/
public class OkeruHantei {

	public boolean okeru_hantei(String[][] arrayBoard, int retu, int gyou, int p) { //p:0、AIが置けるかどうか
		...
		/*既に置かれた場所には置けない*/
		if(!(arrayBoard[gyou][retu].equals("□"))) {
			return false;
		}
